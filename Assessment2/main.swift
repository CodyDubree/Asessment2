...
print("First Name?")
let userResponse1 = readLine()
print("Last Name?")
let userResponse2 = readLine()
var firstName = userResponse1
var lastName = userResponse2
...
var animals = ["dog", "cat", "panda", "bird", "bear"]
...
var optionalInt: String? = nil


if let carCD = optionalInt {
    print("this car has a:\(optionalInt) cd player")
} else {print("this car doesnt have a cd player")
}
